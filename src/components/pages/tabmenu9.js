    ...
    <Box sx={{ width: '100%' }}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <tr>
          ...
          <td className='downside-text'>Витамин D3 (в виде холекальциферола)-15 мкг (600 МЕ) , Кальций (в виде карбоната кальция)-1000 мг, Магний (в виде оксида магния)- 400 мг, и Цинк (в виде глюконата цинка) - 25 мг.</td>
        </tr>
        <tr>
          <td className='downside-text-bolder'>Вспомогательное вещество:</td>
          <td className='downside-text'>дикальцийфосфат, маннит, микрокристаллическая целлюлоза, стеарат магния, диоксид кремния, стеариновая кислота.</td>
        </tr>
        <tr>
          <td className='downside-text-bolder'>Способ применения и дозы:</td>
          <td className='downside-text'>принимать по три (3) таблетки в день, желательно во время еды. Не следует использовать как замену полноценного рациона питания. Не превышайте рекомендуемое дозировки.</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td className='downside-text'>Одна (1) мягкая таблетка.</td>
        </tr>
        </table>
      </TabPanel>
      <TabPanel value={value} index={1}>
        <p className='downside-text'>- заболевания, сопровождающиеся гипокальциемией, гипопаратиреозом (остеопороз, латентная тетания), нарушением обмена витамина D (рахит, остеомаляция), гиперфосфатемией; слабость костей и хрупкость зубов; слабость позвоночника и проблемы с осанкой; проблемы с волосами, кожей и ногтями; ночные судороги ног (особенно икроножных мышц), спортсменам при усиленных нагрузках; повышенная потребность организма в кальции, магнии, цинке и недостаточности их поступления с едой; при нарушении кальциево-магниевого обмена; при усиленном выведении кальция, магния и цинка из организма (длительный постельный режим, вторичная диарея).</p>
      </TabPanel>
