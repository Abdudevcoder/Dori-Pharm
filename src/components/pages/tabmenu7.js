    ...
    <Box sx={{ width: '100%' }}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <tr>
          ...
          <td className='downside-text'>Активное вещество: Биотин - 10000 мкг.</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td className='downside-text'>60 штук таблеток во флаконе.</td>
        </tr>
        <tr>
      ...
      <TabPanel value={value} index={1}>
        <p className='downside-text'>Биотин необходим для восстановления структуры ногтей, эффективно устраняет их ломкость и расслоение. Исследования показали, что биотин способствует устранению мелких морщин кожи лица, шелушений и преждевременного появления  седых волос, выпадения, ломкости волос</p>
      </TabPanel>
