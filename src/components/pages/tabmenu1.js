    ...
    <Box sx={{ width: '100%' }}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <tr>
          ...
          <td className='downside-text'>Фолиевая кислота - 800 мкг.</td>
        </tr>
        <tr>
      ...
      <TabPanel value={value} index={1}>
        <p className='downside-text'>Фолиевая кислота является важным витамином группы В, поддерживающим работу сердца. Кроме того, женщины, соблюдающие здоровую диету с достаточным содержанием фолиевой кислоты, могут снизить риск рождения ребенка с врожденными дефектами головного или спинного мозга.</p>
      </TabPanel>
